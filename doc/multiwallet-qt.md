...
In order to support loading of multiple wallets in castle-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is castle.cpp.
...
Changes to castle.cpp
----------------------
castle.cpp is the entry point into castle-qt, and as such, will require some minor modifications to provide hooks for
