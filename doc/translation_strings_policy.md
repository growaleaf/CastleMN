...
This document provides guidelines for internationalization of the CASTLE Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `castle_en.ts` remains unchanged.
