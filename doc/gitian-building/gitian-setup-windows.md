...
The build script we'll be using is contained in the CASTLE github repository ([contrib/gitian-build.py](https://github.com/castle-project/castle/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the CASTLE repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/CASTLE-Project/CASTLE/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, castle-detached-sigs, and castle GitHub repos.
