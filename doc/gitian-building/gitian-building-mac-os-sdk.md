...
The script [extract-osx-sdk.sh](https://github.com/castle-project/castle/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
castle/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/castle-project/castle/blob/master/doc/README_osx.md) for troubleshooting tips.