...
This mechanism has been integrated into Bitcore-Node-CSTL which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CSTL-Project/insight-api-castle#web-socket-api](https://github.com/CSTL-Project/insight-api-castle#web-socket-api) 
* API: [https://github.com/CSTL-Project/insight-api-castle#swifttx-transactions](https://github.com/CSTL-Project/insight-api-castle#swifttx-transactions) 
