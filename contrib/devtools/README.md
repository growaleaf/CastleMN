...
Setup
---------
Configuring the github-merge tool for the CSTL repository is done in the following way:

    git config githubmerge.repository CSTL-Project/CSTL
...
A script to optimize png files in the CSTL
