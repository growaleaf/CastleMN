...
RESOURCES += src/qt/castle.qrc src/qt/castle_locale.qrc

TRANSLATIONS += src/qt/locale/castle_bg.ts \
                src/qt/locale/castle_de.ts \
                src/qt/locale/castle_en.ts \
                src/qt/locale/castle_es.ts \
                src/qt/locale/castle_fi.ts \
                src/qt/locale/castle_fr.ts \
                src/qt/locale/castle_it.ts \
                src/qt/locale/castle_ja.ts \
                src/qt/locale/castle_pl.ts \
                src/qt/locale/castle_pt.ts \
                src/qt/locale/castle_ru.ts \
                src/qt/locale/castle_sk.ts \
                src/qt/locale/castle_sv.ts \
                src/qt/locale/castle_vi.ts \
                src/qt/locale/castle_zh_CN.ts \
                src/qt/locale/castle_zh_TW.ts
