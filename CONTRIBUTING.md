...
confused with overall CSTL Network Protocol consensus changes.
...
Patches that change CSTL consensus rules are considerably more involved than
...
Where a patch set proposes to change the CSTL consensus, it must have been
