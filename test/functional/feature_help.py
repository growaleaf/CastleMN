...
"""Verify that starting castle with -h works as expected."""
import subprocess

from test_framework.test_framework import CastleTestFramework
from test_framework.util import assert_equal

class HelpTest(CastleTestFramework):
    ...
    def run_test(self):
        self.log.info("Start castle with -h for help text")
        ...
        self.log.info("Start castle with -version for version information")
