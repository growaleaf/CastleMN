...
class RawTransactionsTest(CastleTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid castle address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid castle address" in e.error['message'])
