...
#ifndef CASTLE_STAKEINPUT_H
#define CASTLE_STAKEINPUT_H
...
// zCSTLStake can take two forms
// 1) the stake candidate, which is a zcmint that is attempted to be staked
// 2) a staked zcstl, which is a zcspend that has successfully staked
...
public:
    ...
    bool IsZCSTL() override { return true; }
...
class CCstlStake : public CStakeInput
{
private:
    CTransaction txFrom;
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, std::vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZCSTL() override { return false; }
