...
bool CWalletDB::WriteZCSTLSeed(const uint256& hashSeed, const vector<unsigned char>& seed)
{
...
bool CWalletDB::ReadZCSTLSeed(const uint256& hashSeed, vector<unsigned char>& seed)
{
