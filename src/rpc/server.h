...
extern UniValue DoZcstlSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzcstlseed(const UniValue& params, bool fHelp);
extern UniValue getzcstlseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzcstl(const UniValue& params, bool fHelp);
extern UniValue dzcstlstate(const UniValue& params, bool fHelp);
