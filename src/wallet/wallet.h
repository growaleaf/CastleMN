...
enum WalletFeature {
    ...
    FEATURE_PRE_CASTLE = 61000, // inherited version..
...
enum ZerocoinSpendStatus {
    ...
    ZCSTL_TXMINT_GENERAL = 9,                        // General errors in MintsToInputVectorPublicSpend
...
public:
    ...
    /// Get 10000 CSTL output and keys which can be used for the Masternode
    ...
    void doZCstlRescan(const CBlockIndex* pindex, const CBlock& block, std::set<uint256>& setAddedToWallet, const Consensus::Params& consensus, bool fCheckZCSTL);
    ...
    bool CreateZCSTLOutPut(libzerocoin::CoinDenomination denomination, CTxOut& outMint, CDeterministicMint& dMint);
    ...
    // zCSTL wallet
    CzCSTLWallet* zwalletMain{nullptr};
    std::unique_ptr<CzCSTLTracker> zcstlTracker{nullptr};
    void setZWallet(CzCSTLWallet* zwallet);
    CzCSTLWallet* getZWallet();
