...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 CSTL at the same time
...
public:
    ...
    std::string GetUniqueWalletBackupName(bool fzcstlAuto) const;
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzCSTLTracker> zcstlTracker;
