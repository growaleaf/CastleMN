...
#ifndef CASTLE_ZCSTLWALLET_H
#define CASTLE_ZCSTLWALLET_H
...
public:
    CzCSTLWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZCSTL(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZCSTL(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
