...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetSpacing = 1 * 60;  // CSTL: 1 minute
        ...
        nEnforceStakeInputMinimal = 800000;

        /** Height or Time Based Activations **/
        nLastPOWBlock = 1000;
        nCastleBadBlockTime = 1471401614; // Skip nBit validation of Block 259201 per PR #915
        nCastleBadBlocknBits = 0x1c056dac; // Skip nBit validation of Block 259201 per PR #915
        ...
        nBlockDoubleAccumulated = 19050010;
        ...
        nBIP65ActivationHeight = 802000;
        // Activation height for TimeProtocolV2, Blocks V7 and newMessageSignatures
        nBlockTimeProtocolV2 = 1500000;
        ...
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 184);
        ...
        strSporkPubKey = "04789d4539967e0b7dd1e47ef5f04c766d910482e9f5d626f890a0840fb1857127e0f4eac880758a330ed28024a23d002fa45326abcc2990056287c006dd321eed";
        strSporkPubKeyOld = "04d64f1fbce0758ecb048572f6a25f457ef63e863cd74d7a46f0325764682fa9d131becffccdf332c7d451d8d352eb209a37211cf06b5d4becb14556fe212bd2c3";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 200;
        nCastleBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nCastleBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        strSporkPubKey = "04022ae65de104b75ded40fc01deb5e3079fe6f8b8867db6dea4d94dc89dd192ef5f949cdd40e504cdd62af2edeec3fe53559c3832fab213441b2f0f13bf55bdd1";
