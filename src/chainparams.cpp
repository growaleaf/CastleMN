...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1541436970, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 3 * 60; // CSTL: 1 day
        nTargetSpacing = 3 * 60;  // CSTL: 1 minute
        nMaturity = 40;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // CSTL: 1 day
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "castle-testnet.seed.fuzzbawls.pw"));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "castle-testnet.seed2.fuzzbawls.pw"));
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // CSTL: 1 day
        nTargetSpacing = 1 * 60;        // CSTL: 1 minutes
