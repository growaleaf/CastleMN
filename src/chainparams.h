...
public:
    ...
    int CastleBadBlockTime() const { return nCastleBadBlockTime; }
    int CastleBadBlocknBits() const { return nCastleBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nCastleBadBlockTime;
    unsigned int nCastleBadBlocknBits;
