...
public:
    ...
    */
    ...
    bool fBackupMints;
    std::unique_ptr<CzCSTLTracker> zpivTracker;
    ...
    {
        zwalletMain = zwallet;
        zpivTracker = std::unique_ptr<CzCSTLTracker>(new CzCSTLTracker(strWalletFile));
    }

    CzCSTLWallet* getZWallet() { return zwalletMain; }
