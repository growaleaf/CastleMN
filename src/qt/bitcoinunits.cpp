...
QString BitcoinUnits::name(int unit, bool isZcstl)
{
    QString z = "";
    if(isZcstl) z = "z";
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case CSTL:
            return z + QString("CSTL");
        case mCSTL:
            return z + QString("mCSTL");
        case uCSTL:
            return z + QString::fromUtf8("μCSTL");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case CSTL:
            return z + QString("tCSTL");
        case mCSTL:
            return z + QString("mtCSTL");
        case uCSTL:
            return z + QString::fromUtf8("μtCSTL");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZCSTL)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZCSTL);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZCSTL)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZCSTL));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
