                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Castle Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CSTL address"));
    ...
    annAction = new QAction(QIcon(":/icons/axiom"), tr("Announcement"), this);
    annAction->setStatusTip(tr("Castle  last announcement"));
    ...
    connect(annAction, SIGNAL(triggered()), this, SLOT(gotoAxiomAnnView()));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CSTL"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CSTL addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CSTL addresses"));
    ...
    openAction->setStatusTip(tr("Open a CSTL: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Castle Core help message to get a list with possible CSTL command-line options"));
...
void BitcoinGUI::gotoAxiomAnnView()
{
    annAction->setChecked(true);
    if (walletFrame) walletFrame->gotoAxiomAnnView();
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CSTL network", "", count));
}
