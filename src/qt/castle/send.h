...
#include "qt/castle/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(CASTLEGUI* parent);
    ~SendWidget();
...
private slots:
    void onCSTLSelected(bool _isCSTL);
    void onSendClicked();
...
private:
    ...
    bool sendZcstl(QList<SendCoinsRecipient> recipients);
