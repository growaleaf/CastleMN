...
#include "config/castle-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalCstl = 0;
    qint64 totalZcstl = 0;
    QList<qreal> valuesCstl;
    QList<qreal> valueszCstl;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(CASTLEGUI* _window);
    ~DashboardWidget();
