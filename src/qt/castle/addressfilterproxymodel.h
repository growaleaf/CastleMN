...
#ifndef CASTLE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define CASTLE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //CASTLE_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
