...
void closeDialog(QDialog* widget, CASTLEGUI* gui);
void openDialogFullScreen(QWidget* parent, QWidget* dialog);
bool openDialogWithOpaqueBackgroundY(QDialog* widget, CASTLEGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, CASTLEGUI* gui, double posX = 3);
bool openDialogWithOpaqueBackgroundFullScreen(QDialog* widget, CASTLEGUI* gui);
