...
#include "qt/castle/forms/ui_receivewidget.h"
...
#include "qt/castle/addressholder.h"
...
ReceiveWidget::ReceiveWidget(CASTLEGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive CSTL."));
