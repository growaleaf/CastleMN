...
CASTLEGUI::CASTLEGUI(const NetworkStyle* networkStyle, QWidget* parent) :
        QMainWindow(parent),
        clientModel(0){
...
void CASTLEGUI::connectActions()
{
    ...
    connect(topBar, &TopBar::showHide, this, &CASTLEGUI::showHide);
    connect(topBar, &TopBar::themeChanged, this, &CASTLEGUI::changeTheme);
    connect(topBar, &TopBar::onShowHideColdStakingChanged, navMenu, &NavMenuWidget::onShowHideColdStakingChanged);
    connect(settingsWidget, &SettingsWidget::showHide, this, &CASTLEGUI::showHide);
    ...
    connect(coldStakingWidget, &ColdStakingWidget::execDialog, this, &CASTLEGUI::execDialog);
    connect(settingsWidget, &SettingsWidget::execDialog, this, &CASTLEGUI::execDialog);
}
...
#ifndef Q_OS_MAC
void CASTLEGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void CASTLEGUI::closeEvent(QCloseEvent* event)
{
#ifndef Q_OS_MAC // Ignored on Mac
...
bool CASTLEGUI::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn)
{
    ...
    if (isVisible()) {
        ...
        dialog->setWindowTitle(tr("CASTLE Core"));
        dialog->adjustSize();
        dialog->raise();
        dialog->exec();
    }
...
bool CASTLEGUI::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    connect(addressesWidget, &AddressesWidget::message,this, &CASTLEGUI::message);
...
static bool ThreadSafeMessageBox(CASTLEGUI* gui, const std::string& message, const std::string& caption, unsigned int style)
{
...
void CASTLEGUI::subscribeToCoreSignals()
{
    // Connect signals to client
    uiInterface.ThreadSafeMessageBox.connect(boost::bind(ThreadSafeMessageBox, this, _1, _2, _3));
}

void CASTLEGUI::unsubscribeFromCoreSignals()
{
