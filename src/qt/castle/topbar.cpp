...
#include "qt/castle/loadingdialog.h"
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopCstl}, "amount-small-topbar");
    setCssProperty({ui->labelAmountCstl}, "amount-topbar");
    setCssProperty({ui->labelPendingCstl, ui->labelImmatureCstl}, "amount-small-topbar");
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // CSTL Total
    QString totalCstl = GUIUtil::formatBalance(balance, nDisplayUnit);
