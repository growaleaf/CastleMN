...
#include "qt/castle/coldstakingwidget.h"
#include "qt/castle/forms/ui_coldstakingwidget.h"
#include "qt/castle/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/castle/requestdialog.h"
#include "qt/castle/tooltipmenu.h"
#include "qt/castle/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(CASTLEGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your CSTLs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept CSTL delegation / Delegate CSTL"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select CSTL outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 CSTL" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
