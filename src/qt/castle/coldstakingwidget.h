...
#include "qt/castle/furabstractlistitemdelegate.h"
#include "qt/castle/txviewholder.h"
#include "qt/castle/tooltipmenu.h"
#include "qt/castle/sendmultirow.h"
#include "qt/castle/coldstakingmodel.h"
#include "qt/castle/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(CASTLEGUI* parent);
    ~ColdStakingWidget();
