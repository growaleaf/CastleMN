...
#include "qt/castle/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(CASTLEGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &CASTLEGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
