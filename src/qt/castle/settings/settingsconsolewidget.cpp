...
#include "qt/castle/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/castle/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(CASTLEGUI* _window, QWidget *parent) :
