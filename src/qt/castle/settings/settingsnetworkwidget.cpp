...
#include "qt/castle/settings/settingsnetworkwidget.h"
#include "qt/castle/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/castle/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(CASTLEGUI* _window, QWidget *parent) :
