...
#include "qt/castle/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(CASTLEGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &CASTLEGUI::openFAQ);
