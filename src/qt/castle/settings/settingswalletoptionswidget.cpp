...
#include "qt/castle/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/castle/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(CASTLEGUI* _window, QWidget *parent) :
