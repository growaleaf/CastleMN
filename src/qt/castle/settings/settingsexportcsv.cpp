...
#include "qt/castle/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(CASTLEGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("CASTLE_tx_csv_export(*.csv)") : tr("CASTLE_addresses_csv_export(*.csv)"),
                                        nullptr);
