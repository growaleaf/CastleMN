...
#include "qt/castle/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/castle/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(CASTLEGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to CASTLEGUI::handleRestart()
