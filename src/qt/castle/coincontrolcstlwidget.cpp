...
#include "qt/castle/coincontrolcstlwidget.h"
#include "qt/castle/forms/ui_coincontrolcstlwidget.h"

CoinControlCstlWidget::CoinControlCstlWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlCstlWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select CSTL Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("CSTL");
    ...
    ui->labelValueAfter->setText("0.00 CSTL");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 CSTL");
    ui->labelValueFee->setText("0.00 CSTL");
...
CoinControlCstlWidget::~CoinControlCstlWidget()
{
    delete ui;
}
